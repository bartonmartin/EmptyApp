package cz.bartonmartin.empty.utility;

import android.util.Log;

import cz.bartonmartin.empty.EmptyConfig;
...
public final class Logcat
{
	...
	{
		if(EmptyConfig.LOGS) Log.d(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void e(String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.e(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void e(Throwable tr, String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.e(TAG, getCodeLocation().toString() + formatMessage(msg, args), tr);
	}


	public static void i(String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.i(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void v(String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.v(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void w(String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.w(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void wtf(String msg, Object... args)
	{
		if(EmptyConfig.LOGS) Log.wtf(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}
